package co.edu.colomboamericano.caelstudent.exception;
...
public class AuthException implements AuthenticationEntryPoint {
	...
	/**
     * @author Smarthink
     * @return Retorna validacion personalizada para las peticiones
     * no autorizadas sin token
     */
	@Override
	public void commence(HttpServletRequest request, HttpServletResponse response, AuthenticationException arg2)
		...
		mapException.put("message", "No esta autorizado para acceder a este recurso");
